...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Plot UMAP projections for selected datasets.")
    parser.add_argument("--datasets", type=str, default=None, help="Comma-separated list of dataset names to include.")
    parser.add_argument("--colors", type=str, default="annotation", help="Comma-separated list of colors (genes or annotations).")
    ...
    # Run function
    plot_umap_all(selected_datasets, color, args.save_path)
